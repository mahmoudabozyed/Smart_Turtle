...
static const _TurtleCommand_type_support_symbol_names_t _TurtleCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smart_turtle_interface, msg, TurtleCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smart_turtle_interface, msg, TurtleCommand)),
  }
};
...
{
  return &::smart_turtle_interface::msg::rosidl_typesupport_cpp::TurtleCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smart_turtle_interface, msg, TurtleCommand)() {
  return get_message_type_support_handle<smart_turtle_interface::msg::TurtleCommand>();
}
