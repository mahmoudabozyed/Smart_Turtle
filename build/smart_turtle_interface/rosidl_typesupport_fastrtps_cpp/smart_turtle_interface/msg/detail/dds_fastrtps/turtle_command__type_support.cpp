...
#include "smart_turtle_interface/msg/detail/turtle_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smart_turtle_interface::msg::TurtleCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smart_turtle_interface::msg::TurtleCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smart_turtle_interface::msg::TurtleCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TurtleCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_turtle_interface::msg::TurtleCommand *>(
...
static size_t _TurtleCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TurtleCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TurtleCommand__callbacks = {
...
static rosidl_message_type_support_t _TurtleCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TurtleCommand__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_smart_turtle_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<smart_turtle_interface::msg::TurtleCommand>()
{
  return &smart_turtle_interface::msg::typesupport_fastrtps_cpp::_TurtleCommand__handle;
}
